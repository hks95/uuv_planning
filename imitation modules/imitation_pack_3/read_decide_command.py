...
weight_directory = "./dec1_partialC/"
...
def publish_control_wrench(cur_vel_command):
    ...
    force_msg.wrench.torque.x = wrench[3]
    force_msg.wrench.torque.y = wrench[4]
    force_msg.wrench.torque.z = wrench[5]
...
while not rospy.is_shutdown():
    ...
    command[0] = command_raw[0]
    command[1] = command_raw[1]
    command[2] = command_raw[2]
    command[5] = command_raw[5]
